...
export function ProductsInventory() {
  ...
  if (loading) return <div className="p-8 text-center text-slate-500">جاري تحميل قائمة المنتجات...</div>;
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          ...
          <input
            ...
            className="border border-slate-300 rounded-xl px-4 py-2 text-sm w-full sm:w-64 focus:outline-none focus:ring-2 focus:ring-sky-500"
          />
        </div>
            ...
            <form onSubmit={handleAddStock} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="مثال: 50"
                  className="w-full border border-slate-300 rounded-xl p-2.5 text-base font-semibold text-sky-700"
                />
              </div>
              ...
              <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 text-xs space-y-1">
                <div className="flex justify-between text-slate-600">
                  ...
                  <span className="font-bold">{Math.max(0, (selectedProduct.total_stock || 0) - (selectedProduct.consumed_stock || 0))}</span>
                </div>
                <div className="flex justify-between text-slate-600">
